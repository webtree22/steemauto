...
<br>Please add @steemauto.app to your account's posting auths using one of following apps:<br>
<br><a class="btn btn-success" href="https://steemlogin.com/authorize/@steemauto.app/?redirect_uri=http://localhost/dash.php">SteemLogin</a>
<br>
<br>If you don't add <strong>@steemauto.app</strong> to your posting auths you will not be able to use our site.
</center>
</div>
</div>
</div>
			...
			<div class="content">
				<div class="card">
					<div class="content">
						...
						<a href="https://steemlogin.com/revoke/@steemauto.app" class="btn btn-danger">Unauthorize (Leave SteemAuto)</a>
					</div>
				</div>
			</div>
		</div>
